...
AddEventHandler("vRP:Active",function(Passport,Name)
	...
	SetDiscordAppId(1056658399653273620)
	SetDiscordRichPresenceAsset("static")
	SetRichPresence("#"..Passport.." "..Name)
	SetDiscordRichPresenceAssetSmall("static")
	SetDiscordRichPresenceAssetText("Work Store")
	SetDiscordRichPresenceAssetSmallText("Work Store")
	SetDiscordRichPresenceAction(0,"Entrar na Cidade","https://discord.gg/Nk3Nev3sFj")
