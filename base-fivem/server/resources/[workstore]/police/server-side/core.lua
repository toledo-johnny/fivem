...
-----------------------------------------------------------------------------------------------------------------------------------------
WorkStore = {}
Tunnel.bindInterface("police",WorkStore)
...
-- INITPRISON
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.initPrison(nuser_id,services,fines,text)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- SEARCHUSER
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.searchUser(nuser_id)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- INITFINE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.initFine(nuser_id,fines,text)
	local source = source
	local Passport = vRP.Passport(source)
...
-- REDUCEPRISON
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.reducePrison()
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
