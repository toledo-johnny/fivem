...
-----------------------------------------------------------------------------------------------------------------------------------------
WorkStore = {}
Tunnel.bindInterface("spawn",WorkStore)

local Global = {}

function WorkStore.Characters()
	local Character = {}
	local source = source
...
function WorkStore.CharacterChosen(Passport)
  local source = source
  local license = vRP.Identities(source)
...
function WorkStore.NewCharacter(name, name2, sex)
  local source = source
