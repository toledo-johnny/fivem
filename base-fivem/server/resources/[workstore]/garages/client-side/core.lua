...
-----------------------------------------------------------------------------------------------------------------------------------------
WorkStore = {}
Tunnel.bindInterface("garages",WorkStore)
...
local Garages = {
	...
	-- Police-1 (Public)
	["43"] = { x = -404.75, y = 1197.33, z = 325.96,
		["1"] = { -391.35,1189.65,325.64,102.05 }
	},
	-- HeliPolice-1 (Public)
	["44"] = { x = -437.76, y = 1096.57, z = 335.11,
		["1"] = { -431.64,1101.67,335.13,260.79 }
	},
	-- Police-2 (Public)
...
-- SPAWNPOSITION
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.SpawnPosition(Select)
	local Slot = "0"
	local Checks = 0
	local Selected = {}
	local Position = nil
...
-- CREATEVEHICLE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.CreateVehicle(Model,Network,Engine,Health,Customize,Windows,Tyres)
...
-- SEARCHBLIP
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.SearchBlip(Coords)
...
-- STARTHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.StartHotwired()
	Hotwired = true
...
-- STOPHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.StopHotwired(Vehicle)
	Hotwired = false
...
-- UPDATEHOTWIRED
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.UpdateHotwired(Status)
	Hotwired = Status
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- LOOPHOTWIRED
