...
-----------------------------------------------------------------------------------------------------------------------------------------
WorkStore = {}
Tunnel.bindInterface("party",WorkStore)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Config = {
...
-- GETMEMBERS
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.GetMembers(Number)
	local source = source
	local Passport = vRP.Passport(source)
...
-- CREATEROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.CreateRoom(Name,Password)
	local source = source
	local Passport = vRP.Passport(source)
...
-- CREATEROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.EnterRoom(Number, Password)
	local source = source
	local Passport = vRP.Passport(source)
	...
	if Config["Room"][Number] then
		if Config["Users"][Passport] then
			if Number ~= Config["Users"][Passport] then
				if Config["Users"][Passport] then
					WorkStore.LeaveRoom(Config["Users"][Passport])
				end
...
-- LEAVEROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.LeaveRoom(Room)
	local source = source
	local Passport = vRP.Passport(source)
...
-- KICKROOM
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.KickRoom(Kick,Passport)
	local source = source
