...
-----------------------------------------------------------------------------------------------------------------------------------------
WorkStore = {}
Tunnel.bindInterface("bank",WorkStore)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIABLES
-----------------------------------------------------------------------------------------------------------------------------------------
local Active = {}
...
-- TRANSACTIONS
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.TransactionHistory()
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- BANKDEPOSIT
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Deposit(amount)
	local source = source
	local Passport = vRP.Passport(source)
...
-- BANWITHDRAW
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Withdraw(amount)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Active[Passport] == nil and parseInt(amount) > 0 then
		Active[Passport] = true
...
-- TRANSFERENCE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Transfer(ClosestPed,amount)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Active[Passport] == nil and parseInt(amount) > 0 then
		Active[Passport] = true
...
-- TRANSFERENCE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.TaxPayment(id)
	local source = source
	local Passport = vRP.Passport(source)
	local id = id
...
function WorkStore.InvoiceList()
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- TRANSFERENCE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.InvoicePayment(id)
	local source = source
	local Passport = vRP.Passport(source)
	local id = id
	if Passport and Active[Passport] == nil then
...
-- MAKEINVOICE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.MakeInvoice(OtherPassport, value, reason)
	local source = source
	local Passport = vRP.Passport(source)
...
--  INVESTMENTS
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Investments()
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
...
-- ADD INVESTMENT
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Invest(amount)
	local source = source
	local Passport = vRP.Passport(source)
...
-- REM INVESTMENT
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.InvestRescue()
	local source = source
	local Passport = vRP.Passport(source)
