...
-----------------------------------------------------------------------------------------------------------------------------------------
WorkStore = {}
Tunnel.bindInterface("propertys",WorkStore)
...
-- PROPERTYS
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Propertys(Name)
	local source = source
...
-- OPENCHEST
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.OpenChest(Name,Mode)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport then
		local Chest = {}
...
-- STORE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Store(Item,Slot,Amount,Target,Name,Mode)
	local source = source
...
-- TAKE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Take(Slot,Amount,Target,Name,Mode)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport then
...
-- UPDATE
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Update(Slot,Target,Amount,Name,Mode)
	local source = source
	local Amount = parseInt(Amount)
	local Passport = vRP.Passport(source)
	if Passport then
