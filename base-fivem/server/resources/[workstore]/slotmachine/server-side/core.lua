...
-----------------------------------------------------------------------------------------------------------------------------------------
WorkStore = {}
Tunnel.bindInterface("slotmachine",WorkStore)
...
-- CHECK
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Check(Table)
	local source = source
...
-- CLEAN
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Clean(Table)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Machines[Table] then
...
-- PAYMENT
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Payment(Table)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Machines[Table] then
...
-- STARTSLOTS
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.StartSlots(Table)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Machines[Table] then
		local Result = {
...
-- WINNER
-----------------------------------------------------------------------------------------------------------------------------------------
function WorkStore.Winner(Table,Result)
	local source = source
	local Passport = vRP.Passport(source)
